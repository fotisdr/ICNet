...
This repository contains the source code of the ICNet model and an example Jupyter notebook `ICNet_example.ipynb` that can be used to simulate neural activity in the inferior colliculus (IC) in response to a sound stimulus. The notebook can also be directly executed on [Binder](https://mybinder.org/v2/gh/fotisdr/ICNet/HEAD?urlpath=%2Fdoc%2Ftree%2FICNet_example.ipynb) without a local Python installation. The supporting work can be found [here](https://www.nature.com/articles/s42256-025-01104-9) (or on [bioRxiv](https://doi.org/10.1101/2024.06.17.599294)) and can be cited as follows:
> Drakopoulos, F., Pellatt, L., Sabesan, S., Xia, Y., Fragner, A. & Lesica, N. A. (2025). Modelling neural coding in the auditory midbrain with high resolution and accuracy. Nature Machine Intelligence 7, 1478–1493; doi: [10.1038/s42256-025-01104-9](https://doi.org/10.1038/s42256-025-01104-9)
...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/fotisdr/ICNet/HEAD?urlpath=%2Fdoc%2Ftree%2FICNet_example.ipynb)
